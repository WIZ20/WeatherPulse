...
function sendInstructionalMessage() {
  const instructionMessage =
    "Hello! I am your WeatherPulse Assistant 🌤. I can provide weather information for you. To get started, type 'weather in [a city's name]' to get the weather for that city. Or you can also ask me any general weather-related questions or any other queries you may have. How can I assist you today? 🌤";
...
async function getBotResponse(message) {
  ...
  try {
    ...
    const model = genAI.getGenerativeModel({
      ...
      systemInstruction:
        'You are a weather assistant, also known as WeatherPulse Assistant, for the WeatherPulse App. The app is created by Shubhanshu Kumar Yadav. Your task is to provide weather information to users. You can also provide general information about weather and answer weather-related questions, or any other queries the user may have, with appropriate responses.',
    });
...
chatTitleElem.innerText = 'Chat With Your WeatherPulse!';
...
chatInput.addEventListener('keydown', e => {
  if (e.key === 'Enter' && e.target.value.trim()) {
    ...
    setTimeout(async () => {
      ...
      elizaMsgElem.innerText = `WeatherPulse: ${response}`;
